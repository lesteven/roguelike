...
Game._playerStatus = function(){
	...
	this._display.draw(25,this.height-3,'Level: '+ Game.level)
	this._display.draw(45,this.height-3,'XP: '+ Game.xp)
	this._display.draw(65,this.height-3,'Weapon: '+ Game.weapon)
	this._display.draw(85,this.height-3,'Attack: '+ Game.attack)
}